...
- Vision systems (YOLO-v8, semantic segmentation)
...
- Understanding of robotics concepts (optional)
- Linux experience (recommended)

## Getting Help

Use the integrated chatbot (bottom-right corner) to:
- Ask questions about any lesson
- Get code examples
- Understand robotics concepts
- Search across the entire textbook
