...
- Chapter 3: Synthetic data generation with Isaac Sim
- Chapter 4: Vision-language agents for robotics
- Advanced topics: Autonomous navigation, manipulation, perception
...
**Later chapters** (Chapter 2+) progress to more realistic simulators:
- **Chapter 2**: Gazebo (physics simulation, URDF robots, sensors)
- **Chapter 3**: Isaac Sim (photorealistic rendering, synthetic data)
- **Chapter 4+**: Real hardware (with simulation mastery as prerequisite)
...
- OpenAI ChatGPT and vision API
- Integrating vision with ROS 2
- Building AI agents for robotics
